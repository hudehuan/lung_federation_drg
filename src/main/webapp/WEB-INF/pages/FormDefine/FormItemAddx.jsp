...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            // 自定义参数调用
            formValiPost("xinzeng", "${ctx}/formItem/save", function (json) {
...
<body>
<form id="xinzeng" action="${ctx}/formItem/save" method="post">
    <div class="container from-content">
        ...
        <div class=" div_border">
            ...
            <div class="div_h" style="margin-left:20px;">
                <input  type="checkbox" placeholder=" "id="isText" name="isText" />
                <label for="isText">&nbsp;&nbsp;文本</label>
            </div>
        </div>
        <div class="div_border">
            <label for="itemName">名称&nbsp;&nbsp;&nbsp;&nbsp;</label>
            <input type="text" placeholder=" " id="itemName" name="itemName"
        ...
        <div class=" div_border">
            ...
            <textarea  id="sfDesc" type="text" name="sfDesc"  class="form-control bi-width357" style="height:60px;"></textarea>
        </div>
