...
<head>
    ...
    <script>
        ...
        function loadList() {
            $('#gridtable').datagrid(
                {
                    url:'/DicIcd10Define/getList?search=&rdm='+ parseInt(Math.random()*100000),
                    rownumbers:true,
                    method:'get',
                    singleSelect:true,
                    autoRowHeight:false,
                    ...
                    columns: [
                        [
                            ...
                            { field: 'icd10Dm', title: '系统Icd10编码', width: '100px', align: 'left',sortable:true,  halign: 'center'},
                            { field: 'icd10Mc', title: '系统Icd10名称', width: '100px', align: 'left',sortable:true, halign: 'center'},
        ...
        function toAdd() {
            ...
            layeropen(0.45*width,height-100, "数据编辑", "/V_DicIcd10Define/toEdit");
        }

        function del(id) {
            layerConfirm("是否确定删除?", function () {
                var url = '${ctx}/DicIcd10Define/del?id=' + id;
                $.ajax({
                    type: 'post',
                    url: url,
                    dataType: "json",
        ...
        function search(){
            ...
            $('#gridtable').datagrid(
                {
                    url:'/DicIcd10Define/getList?search='+encodeURI(search)+'&rdm='+ parseInt(Math.random()*100000)
                })
        }
