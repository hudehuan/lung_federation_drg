...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            formValiPost2("formid", "${ctx}/DicIcd10Define/save",validateForm, function (json) {
                parent.reLoadList();
...
//            $('#gridtable').datagrid(
//                {
//                    url:'/DicIcd10/getList?search=&rdm='+ parseInt(Math.random()*100000),
//                    method:'get',
//                    singleSelect:true,
//                    autoRowHeight:false,
//                    pagination:true,
...
//                            { field: 'dm', title: 'icd10编码', width: '80px', align: 'left',sortable:true,  halign: 'center'},
//                            { field: 'mc', title: 'icd10名称', width: '200px', align: 'left',sortable:true, halign: 'center'},
//                            { field: 'lx', title: 'icd10类型', width: '100px', align: 'left',sortable:true, halign: 'center'},
//                        ]
//                    ],
...
//                }).datagrid('clientPaging');
        ...
        function search() {
            ...
            $('#gridtable').datagrid(
                {
                    url: '/DicIcd10/getList?search='+encodeURI(search)+'&rdm=' + parseInt(Math.random() * 100000)
                })
        }
    ...
    <div style="width:100%;float:right;display:inline-block; padding:10px 20px 10px 60px;border-left:1px solid #ddd;">
        ...
        <div style="padding:0 10px 0px 0px;margin-left:0px;">
            <form id="formid"  method="post">
                <input type="hidden" name="icd10Dm" id="icd10dm" value="${entity.icd10Dm}"/>
                <input type="hidden" name="id" id="id" value="${entity.id}"/>
                <input type="hidden" name="icd10Mc" id="icd10mc" value="${entity.icd10Mc}"/>

                <div class="div_border"  style="padding:10px 20px">
                    <div class="div_h">
                        <label for="icd10" style="margin-right:10px;">icd10名称</label>
                        <input type="text"   name="icd10" id="icd10" class="form-control " style="width:140px;height: 20px;"/>
                        <b class="redColor">*</b>
                    </div>
                </div>
                ...
                <div class="div_border"  style="padding:10px 20px">
                    <div class="div_h">
                        <label for="code" style="margin-right:18px;">对照编码</label>
                ...
                <div class="div_border"  style="padding:10px 20px">
                    <div class="div_h">
                        <label for="type" style="margin-right:18px;">编码类型</label>
