...
<form action="${ctx}/SysDictionary/save" method="post" id="zidian">
    ...
    <input type="hidden" id="isSys" value="${isSys}">
    <input type="hidden" name="sysCode" value="${dic.sysCode}">
    <div class="container from-content">
        ...
        <div class=" div_border">
            ...
            <input type="text" placeholder=" " id="bz" name="bz" class="bi-width357  form-control" style="width:371px;" value="${dic.bz}"/>
