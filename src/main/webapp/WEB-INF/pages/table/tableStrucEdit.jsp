...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#type option[value='${tablestruc.type}']").attr("selected", "selected");
            if('${tablestruc.isKey}'){
                $("#isKey").attr("disabled","disabled");
            }
            if('${tablestruc.name}'){
            ...
            if('${tablestruc.colLength}'){
                $("#colLength").attr("readonly","readonly");
            }
            <%--$("#type").val('${tablestruc.type}');--%>
            // 自定义参数调用
...
<form  id="yuansuju" action="${ctx }/tabstruc/save " method="post">
    ...
    <input type="hidden" name="id" id ="id" value="${tablestruc.id}"/>
    <div class="container from-content">
        <div class="div_border" style="padding:10px 20px">
            ...
            <input  id="xh" type="number" name="xh" class="bi-width140  form-control"
                    onkeydown="DigitInput()" value="${tablestruc.xh}"/>
        </div>
        <div class="div_h" style="margin-left:27px;">
            <input type="hidden" name="isKey" value="${tablestruc.isKey}"/>
            <input id="isKey" type="checkbox" value="${tablestruc.isKey}" />
    ...
    <div class="div_border" style="padding:10px 20px">
        <div class="div_h">
            ...
            <input  id="name" type="text" name="name" class="bi-width140  form-control validate[required]"
                     value="${tablestruc.name}"/>
            <b class="redColor">*</b>
        </div>
        <div class="div_h"style="margin-left:16px;">
            <label for="zhName">中文名&nbsp;&nbsp;</label>
            <input  id="zhName" type="text" name="zhName" class="bi-width140 form-control validate[required]" value="${tablestruc.zhName}"/>
            <b class="redColor">*</b>
        </div>
    </div>
    <div class="div_border" style="padding:10px 20px">
        <div class="div_h">
            ...
            <%--<input type="hidden" name="type" value="${tablestruc.type}"/>--%>
        ...
        <div class="div_h" style="margin-left:20px;">
            ...
            <input  id="colLength" type="number" name="colLength" class="bi-width140 form-control validate[required]"
                    onkeydown="DigitInput()" value="${tablestruc.colLength}" />
            <b class="redColor">*</b>
        </div>
    </div>
    <div  class=" div_border" style="padding:10px 20px">
        <label for="bz" style="margin-right: 11px;margin-left: 11px;">备注&nbsp;&nbsp;&nbsp;</label>
        <input  type="text" placeholder=" "id="bz" name="bz" class="bi-width357  form-control" value="${tablestruc.bz}" />
