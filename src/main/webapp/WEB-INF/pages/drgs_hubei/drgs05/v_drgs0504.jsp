...
<div id="menu" style="position:fixed;top: 10px;right: 20px;z-index:20000;font-size:12px;">
    ...
    <ul>
        <li><a href="#item1" class="current"><span></span>- -费用时间消耗比</a></li>
        <li><a href="#item2"><span></span>- -每CMI床日费用</a></li>
    </ul>
</div>--%>
...
<div class="main">
    ...
    <%--</div>--%>
    <%--</div>--%>
    <%--<div id="item2" class="man-c-2" style="padding-top: 46px;">--%>
    <%--<div class="bg-f" style="overflow: hidden;height:auto">--%>
    <%--<div class="zhibiao-top back-zb">--%>
    <%--<b class="back-b zbmca">费用时间消耗比</b>--%>
    <%--</div>--%>
    ...
    <div id="item1" class="man-c-2" style="padding-top: 46px;">
        <div class="bg-f" style="overflow: hidden;min-height: 400px;">
            ...
            <div class="zhibiao2" id="data1" style="">
    ...
    <div id="item2" class="man-c-2" style="padding-top: 0px;">
        <div class="bg-f" style="overflow: hidden;height:auto">
            <div class="zhibiao-top back-zb">
                <b class="back-b zbmca">每CMI床日费用</b>
...
<script>
    ...
    var H = 0;
    var loads =0;
    var biIds = ['4cd9b2ba-fbca-4b17-87ae-176f199b38ac'];//报表id
    ...
    function search(stats) {
        ...
        var url0 = '${biIp}/view/Dsnreport/ajax/AjaxGetReportJsonpData.ashx?callback=?&biqtuser=${biqtuser}&bivar=' +escape(escape("@novalue|"+bivars[1]+"|"+bivars[2]+"|"))+
...
//            str.push(datay[i].cell[6]);
        ...
        var option = dlchart.CreateCatterChart("", {x: "每权重消耗住院住院床日数", y: "每权重消耗费用"}, [{name: "区域医疗服务效率示意图", data: attr}],
            {
                grid: {
                    left: '3%',
                    right: '8%',
...
//        var dataIndex = [0, 1, 2, 3, 4, 5, 6];
        var tableData = initBootstrapTableData(data);//jsop数据格式化为layuiTable数据格式
        tableData.data[0].td9='-';
        tableData.data[0].td10='-';
        var $table = $('#table1');
        tableData.data.sort(compare("td10"));
        if(flag==true) {
            $("#thead1").empty();
    ...
    function setData2(data) {
        ...
        var option = dlchart.CreateLineChart("", datax, [{name: '', data: datay}], {
            grid: {
                left: '3%',
                right: '8%',
                bottom: '3%',
...
//        n++;
//        getFullCanvasDataURL('data0','daochuimg1',n+'区域医疗服务效率示意图.png');
//        var tablehtml1='<tr><td colspan="11" style="width: 1139px;height: 360px;"><img src="'+n+'区域医疗服务效率示意图.png"></td></tr>'
//        var tablehtml=tablehtml1+$('#table1 thead').html()+$('#table1 tbody').html();
//        tableToExcel('table',tablehtml,'费用时间消耗比');
    });
    $('#daochu1').click(function () {
        ...
        ExcelDown(excleJson);
//        n++;
//        getFullCanvasDataURL('data2','daochuimg2',n+'每CMI床日费用.png');
//        var tablehtml1='<tr><td style="width: 1139px;height: 350px;"><img src="'+n+'每CMI床日费用.png"></td></tr>'
//        var tablehtml=tablehtml1;
//        tableToExcel('table',tablehtml,'每CMI床日费用');
    });
</script>
</body>
</html>
