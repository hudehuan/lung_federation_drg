...
<div class="main-center">
    ...
    <div id="item4" class="man-c-2">
        <div class="bg-f" style="overflow: hidden;min-height:285px;">
            ...
            <div class=" zhibiao2">     <%--<p class="tit-zhibiao">州市数据</p>--%>
    ...
    <div id="item5" class="man-c-2">
        <div class="bg-f" style="overflow: hidden;min-height:315px;">
            ...
            <div class="zhibiao2 table-div" id="data5" style="min-height:110px;" >
                <div class="zhibiao2">
                    <div  class="biaoge-yqst table-responsive" style="margin:15px;">
...
<script>
    ...
    function setData0(data){
        ...
        var   option = dlchart.CreateCatterChart("",{x:"DRGs组数",y:"CMI"},[{name:"权重",data:attr}],{ grid: {
            left: '3%',
            right: '8%',
            bottom: '3%',
            containLabel: true
...
index:0,option:{
    ...
    function setData1(data){
        ...
        var   option = dlchart.CreateLineChart("",chartdata[0].data,[chartdata[3],chartdata[4]],{color:colors,grid: {
            left: '3%',
            right: '8%',
            bottom: '3%',
            containLabel: true
    ...
    function setData5(data)
    {
        ...
        $table.on("click-row.bs.table", function (e, row, element) {
            $('.success').removeClass('success');//去除之前选中的行的，选中样式
            $(element).addClass('success');//添加当前选中的 success样式用于区别
            var index = $('#table2').find('tr.success').data('index');//获得选中的行的id
        });
        tableData.data.length<=6&&$('.fixed-table-pagination').css('border-top','none');
    }
