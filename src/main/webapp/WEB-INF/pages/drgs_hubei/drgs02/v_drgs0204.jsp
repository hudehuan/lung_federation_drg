...
<div id="menu"  style="position:fixed;top: 10px;right: 20px;z-index:20000;font-size:12px;">
    ...
    <ul>
        <li><a href="#item1" class="current"><span></span>- -医疗机构费用控制</a></li>
        <li><a href="#item2"><span></span>- -医院平均住院费用增长率排名</a></li>
        <li><a href="#item3"><span></span>- -医院平均住院日增长率排名</a></li>
        <li><a href="#item4"><span></span>- -医院药占比增长率排名</a></li>
        <li><a href="#item5"><span></span>- -医院诊断费占比增长率排名</a></li>
        <li><a href="#item6"><span></span>- -医院耗材费占比增长率排名</a></li>
...
<div class="main-center">
    ...
    <div id="item1" class="man-c-2">
        <div class="bg-f" style="overflow: hidden;min-height:205px;">
            <div class="zhibiao-top back-zb">
                <b class="back-b">医疗机构费用控制</b>
            </div>
            <div class=" zhibiao2">
    ...
    <div id="item2" class="man-c-2">
        <div class="bg-f" style="overflow: hidden;height:auto">
            <div class="zhibiao-top back-zb">
                <b class="back-b">医院平均住院费用增长率排名</b>
            </div>
