...
<div class="main-center">
    ...
    <div class="man-c-2">
        <div class="bg-f" style="overflow: hidden;height:auto">
            <div class="zhibiao-top back-zb" >
                <b class="back-b">费用增长动因分析</b>
            </div>
            <div class="zhibiao2" id="tb-yft" >
                <p class="tit-zhibiao" style="margin-left:20px">以ID：18机构为例</p>
                <div class="col-xs-6 zhibiao1">
                    <!--<p class="tit-zhibiao">月趋势图</p>-->
                    <div  class=" table-responsive">
                        <table class="table table-bordered back-jodh">
                            <thead>
                            <tr>
                                <td>门诊费用动因分析</td>
                                <td>2015</td>
                            ...
                            <tr>
                                <td>门诊总费用</td>
                                <td class="hui-se-6">7431192.17</td>
                                <td class="hui-se-6">7431192.17</td>
                                <td class="hui-se-6">6534936.49</td>
                                <td class="chen-se">21.35%</td>
                            </tr>
                            <tr>
                                <td>门诊均费</td>
                                <td class="hui-se-6">265.62</td>
                                <td class="hui-se-6">328.93</td>
                                <td class="hui-se-6"></td>
                                <td class="hui-se-6"></td>
                            </tr>
                            <tr>
                                <td>门诊量</td>
...
//				    },
    ...
    $(window).load(function() {
        ...
        // 指定图表的配置项和数据
        //	        app.title = '多 X 轴示例';
        var colors = ['#6cafe3', '#56cf88','#f97777'];
        var option = {
//				title: {
//				        text: '对数轴示例',
//				        left: 'center'
//				    },
    ...
    $(window).load(function() {
        ...
        // 指定图表的配置项和数据
        //	        app.title = '多 X 轴示例';
        var colors = ['#6cafe3', '#56cf88','#f97777','#63d1e2'];
        var option = {
            color:colors,
            tooltip: {
                trigger: 'item',
