...
<script>
    $(function(){
        var ifranmeArryay =
            [{"url":"${ctx}/hubei/V_Drgs0804/toList?hospital=${hospital}&year=${year}&kemu=${kemu}&mdctj=${mdctj}&yhqx=${yhqx}&rqkj=${rqkj}","id":"drga0804","name":"科室医师医疗服务能力、质量、效率总览"},
            {"url":"${ctx}/hubei/V_Drgs0805/toList?hospital=${hospital}&year=${year}&kemu=${kemu}&mdctj=${mdctj}&yhqx=${yhqx}&rqkj=${rqkj}","id":"drga0805","name":"医师医疗服务绩效综合评价"}];
