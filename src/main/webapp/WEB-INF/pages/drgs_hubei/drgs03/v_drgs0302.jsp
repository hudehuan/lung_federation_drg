...
<div id="menu"  style="position:fixed;top: 10px;right: 20px;z-index:20000;font-size:12px;">
    ...
    <ul>
        <li><a href="#item1" class="current"><span></span>- -特定病组工作效率</a></li>
        <li><a href="#item2"><span></span>- -床位效率</a></li>
        <li><a href="#item3"><span></span>- -医生负担</a></li>
        <li><a href="#item4"><span></span>- -时间、费用消耗情况</a></li>
        <li><a href="#item5"><span></span>- -疾病CMI值排名</a></li>
        <li><a href="#item6"><span></span>- -疾病总权重排名</a></li>
    </ul>
</div>
...
<script>
    ...
    var biIds =['aa3b015c-37ab-49f9-94fa-ae2e886a0e5a'];//报表id
...
//        var day = date.getDate();
    ...
    function setData3(data){
        ...
        var colors = ['#4ea397'];
        var option=dlchart.CreateCatterChart("",{x:"费用消耗指数",y:"时间消耗指数"},[{name:"疾病名称",data:attr}],
            {grid: {
                left: '3%',
                right: '8%',
                bottom: '3%',
