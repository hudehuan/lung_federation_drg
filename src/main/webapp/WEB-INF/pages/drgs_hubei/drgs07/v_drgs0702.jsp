...
<%--<div id="menu"  style="position:fixed;top: 10px;right: 20px;z-index:20000;font-size:12px;">
    ...
    <ul>
        ...
        <li><a href="#item2"><span></span>- -机构能力评分排名</a></li>
    </ul>
</div>--%>
...
<script>
    var jsonpData =
        {
            "title":{
                "column":"机构代码,所属区域,患者数,权重数,CMI,组数,能力评分,排序",
            },
            "rows":{
                "row":[
                    {
...
//        data = jsonpDataInit(data);  //jsonp数据格式化
    ...
    function setData0(data) {
        ...
        var option=dlchart.CreateCatterChart("",{x:"DRGs组数",y:"CMI值"},[{name:"",data:attr}],
            {grid: {
                left: '3%',
                right: '8%',
                bottom: '3%',
