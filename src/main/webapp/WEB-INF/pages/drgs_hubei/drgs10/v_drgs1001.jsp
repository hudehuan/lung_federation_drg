...
<div id="menu"  style="position:fixed;top: 10px;right: 20px;z-index:20000;font-size:12px;">
    ...
    <ul>
        <li><a href="#item1" class="current"><span></span>- -CMI、完成权重数</a></li>
        <li><a href="#item2"><span></span>- -费用时间消耗比</a></li>
        <li><a href="#item3"><span></span>- -每CMI床日费用</a></li>
    </ul>
</div>
...
<div class="main">
    ...
    <div id="item3" class="man-c-2" style="padding-top: 46px;">
        <div class="bg-f" style="overflow: hidden;height:auto">
            <div class="zhibiao-top back-zb">
...
//        data = jsonpDataInit(data);  //jsonp数据格式化
    ...
    function setData0(data) {
        ...
        var option=dlchart.CreateCatterChart("",{x:"完成权重数",y:"CMI"},[{name:"就诊量",data:attr}],
            {grid: {
                left: '3%',
                right: '8%',
                bottom: '3%',
    ...
    function setData1(data) {
        ...
        var option=dlchart.CreateCatterChart("",{x:"",y:""},[{name:"",data:attr}],
            {grid: {
                left: '3%',
                right: '8%',
                bottom: '3%',
    ...
    function setData2(data){
        ...
        for(var i=0;i<attr.length;i++){
            ...
            var option =dlchart.CreateLineChart("每CMI床日费用",datax,[{name:'',data:datay}],{grid: {
                left: '3%',
                right: '8%',
                bottom: '3%',
                containLabel: true
