package com.dldata.drgs.controller.drgs_hubei.drgs10;
 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs1001")
public class V_Drgs1001Controller {
    @Autowired
    ...
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid)throws Exception {
        ...
        return "/drgs_hubei/drgs10/v_drgs1001";
    }
}
