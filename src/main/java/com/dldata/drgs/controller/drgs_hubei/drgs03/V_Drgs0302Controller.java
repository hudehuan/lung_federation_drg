package com.dldata.drgs.controller.drgs_hubei.drgs03;
 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs0302")
public class V_Drgs0302Controller {
    @Autowired
    ...
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid)throws Exception {
        ...
        return "/drgs_hubei/drgs03/v_drgs0302";
    }
}
