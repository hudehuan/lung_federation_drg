package com.dldata.drgs.controller.drgs_hubei.drgs04;
 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs0403")
public class V_Drgs0403Controller {
    @Autowired
    ...
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid)throws Exception {
        ...
        return "/drgs_hubei/drgs04/v_drgs0403";
    }
}
