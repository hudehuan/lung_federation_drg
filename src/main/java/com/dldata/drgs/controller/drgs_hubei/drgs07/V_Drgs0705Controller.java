package com.dldata.drgs.controller.drgs_hubei.drgs07;
 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs0705")
public class V_Drgs0705Controller {
    @Autowired
    ...
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid)throws Exception {
        ...
        return "/drgs_hubei/drgs07/v_drgs0705";
    }
}
