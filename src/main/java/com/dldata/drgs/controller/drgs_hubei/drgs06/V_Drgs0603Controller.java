package com.dldata.drgs.controller.drgs_hubei.drgs06;
 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs0603")
public class V_Drgs0603Controller {
    @Autowired
    ...
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid)throws Exception {
        ...
        return "/drgs_hubei/drgs06/v_drgs0603";
    }
}
