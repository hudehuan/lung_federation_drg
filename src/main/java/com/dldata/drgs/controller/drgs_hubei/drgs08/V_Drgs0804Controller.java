 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs0804")
public class V_Drgs0804Controller {
    @Autowired
    SysUserInfoService sysUserInfoService;
    @RequestMapping("/toList")
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid,
                         String hospital,String year,String kemu, String mdctj,String yhqx,String rqkj)throws Exception {
        ...
        return "/drgs_hubei/drgs08/v_drgs0804";
    }
}
