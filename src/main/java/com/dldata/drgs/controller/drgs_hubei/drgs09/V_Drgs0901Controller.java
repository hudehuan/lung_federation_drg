package com.dldata.drgs.controller.drgs_hubei.drgs09;
 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs0901")
public class V_Drgs0901Controller {
    @Autowired
    ...
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid)throws Exception {
        ...
        return "/drgs_hubei/drgs09/v_drgs0901";
    }
}
