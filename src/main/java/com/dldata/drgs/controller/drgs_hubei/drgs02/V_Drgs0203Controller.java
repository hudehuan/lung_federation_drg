package com.dldata.drgs.controller.drgs_hubei.drgs02;
 ...
 */
@Controller
@RequestMapping("/hubei/V_Drgs0203")
public class V_Drgs0203Controller {
    @Autowired
    ...
    public String toList(Model model, @CookieValue(value = "userid",defaultValue = "")String userid)throws Exception {
        ...
        return "/drgs_hubei/drgs02/v_drgs0203";
    }
}
